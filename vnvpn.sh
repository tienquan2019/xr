...
[[ $EUID -ne 0 ]] && echo -e "[${red}Error${plain}] Chưa vào root!, vui lòng xin phép ROOT trước!" && exit 1
...
Nodes:
  -
    ...
    ApiConfig:
      ApiHost: "https://vnvpn.net"
      ApiKey: "vnvpn.net@gmail.com"
      NodeID: 2
    ...
    ControllerConfig:
      ...
      CertConfig:
        ...
        CertDomain: "hn2.vnvpn.net" # Domain to cert
        CertFile: /etc/XrayR/cert/node1.test.com.cert # Provided if the CertMode is file
        KeyFile: /etc/XrayR/cert/node1.test.com.key
        Provider: alidns # DNS cert provider, Get the full support list here: https://go-acme.github.io/lego/dns/
        Email: test@me.com
        DNSEnv: # DNS ENV option used by DNS provider
          ALICLOUD_ACCESS_KEY: dinhtienquan@gmail.com
          ALICLOUD_SECRET_KEY: 8c2799355967b862e49c4e449dbccf389ba81
EOF
...
while true; do
  echo "-----VNVPN-----"
  echo "Địa chỉ dự án và tài liệu trợ giúp:  https://github.com/tienquan2019/xr"
  echo "https://vnvpn.net"
